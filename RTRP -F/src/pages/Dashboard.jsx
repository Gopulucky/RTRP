...
import { Search, TrendingUp, Clock, Zap, ArrowRight, Sparkles, Filter, ChevronRight, Activity } from 'lucide-react';
                ...
                <div className="flex-1 pt-4">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-6">
                        ...
                        <span className="text-xs font-bold text-gray-300 tracking-widest uppercase">
                            {onlineUsers.length} Users Trading Live
                        </span>
                    </div>
                    ...
                    <p className="text-xl text-gray-400 max-w-lg leading-relaxed mb-8">
                        Welcome back, {currentUser.name.split(' ')[0]}. You have 3 pending requests and a session starting in 20 minutes.
                    </p>

                    <button className="group px-8 py-4 bg-white text-black font-bold text-lg rounded-full hover:bg-purple-50 transition-all flex items-center gap-3 shadow-[0_0_20px_rgba(255,255,255,0.3)]">
                        Browse Marketplace
